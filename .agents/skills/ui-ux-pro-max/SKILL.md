...
Run the commands below from this skill directory (`.agents/skills/ui-ux-pro-max`), or resolve `scripts/` against this SKILL.md location. No Claude-specific environment variable is required.
