...
이 파일은 2026-09-26 코드 품질 개선 라운드(PR #10-12: Unicode 서로게이트 버그 Python+TS, ContextSelect sentinel 아키텍처 개선, CI 파이프라인 신설) 직전의 HANDOFF.md 전체를 보존한다. 그 이전 기록은 [handoff-history-through-2026-09-25-b.md](handoff-history-through-2026-09-25-b.md)에 있다. 아래 "사용자 확인 필요" 목록의 Unicode 버그 항목은 이후 라운드에서 **수정 완료**됐다 — 더 이상 미해결이 아니다. 현행 진입점은 [HANDOFF](../../HANDOFF.md)와 [INDEX](../../docs/INDEX.md)다.
